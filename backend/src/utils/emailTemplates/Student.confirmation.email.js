export const StudentConfirmationEmail = (data) => {
  return `
        ...
        <td>
            <table width="545" cellpadding="0" cellspacing="0">
              ...
              ">
                        ...
                        line-height: 1.2rem;
                      ">
                                       This is a special reminder to confirm your meeting with ${data.volunteerName} on ${data.date}.
                                    </p>
                                    <p style="
                        margin-top: 0;
                        font-size: 14px;
                      ...
                      ">
                        ...
                        line-height: 1.2rem;
                      ">
                                        This is ${data.volunteerName}’s email: ${data.volunteerEmail}
                                    </p>
                                    <p style="
                                    margin-top: 0;
                                    margin-bottom: 6px;
                                    ...
                                    line-height: 1.2rem;
                                  ">
                                        Please feel free to contact ${data.volunteerName} if you have any question. ${data.volunteerName} would be ready to give necessary assistance.
                                    </p>
                                    <p style="
                                    margin-top: 0;
                                    margin-bottom: 6px;
