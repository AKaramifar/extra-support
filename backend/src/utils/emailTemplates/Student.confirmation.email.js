  ...
  ">
                           This a confirmation of your meeting with ${data.volunteerName} on
                            ...
                            <a class="extra-support-calender-gmail"
                                href="http://www.google.com/calendar/event?action=TEMPLATE&text=Session%20with%20${data.volunteerName}&dates=${data.calendarDate}&location=${data.location}&details=${data.description}">
                                add to calendar
                            </a>
                        </p>
                        <p style="
